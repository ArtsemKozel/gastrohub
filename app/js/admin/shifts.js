            ...
            <div style="display:flex; align-items:center; gap:0.5rem;">
                ...
                <div style="display:flex; flex-direction:column; flex-shrink:0;">
                    <button onclick="openEditTimeEntry('${te.id}','${employeeId}','${dateStr}','${cin}','${coutEdit}','${pauseMin}','${entryDate}')"
                        style="background:none; border:none; cursor:pointer; color:#B28A6E; font-size:1.1rem; padding:0.25rem;" title="Eintrag bearbeiten">
                        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"/><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"/></svg>
                    </button>
                    <button onclick="deleteTimeEntry('${te.id}','${employeeId}','${dateStr}')"
                        style="background:none; border:none; cursor:pointer; color:#B28A6E; font-size:1.1rem; padding:0.25rem;" title="Eintrag löschen">
